...
def update_profile(request):
    ...
    if request.method == 'POST':
        ...
        request.method = 'GET'
        return newProfile(request)
    return render(request, 'dashboard/profile_update.html', {'profile': profile, 'id': id,'detail':detail})
...
def addcvdetail(request):
    ...
    return render(request, 'dashboard/resume_form.html', {'profile': profile, 'id': id,'detail':detail})
...
def selectcv(request):
    ...
    return render(request, 'dashboard/selectCV.html',{'flag':profile,'detail':detail})
...
def addcvdetail2(request):
    ...
    return render(request, 'dashboard/resume_form2.html', {'profile': profile, 'id': id,'detail':detail})
